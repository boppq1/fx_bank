...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
        		...
        		.requestMatchers("/a","/", "/login","/register","/reauth", "/api/auth/**","/products", "/product/**","/fx/**", "/api/fx/**","/css/**", "/js/**", "/admin/**", "/error", "/event/**", "/event-status", "/chatbot/**", "/mbti", "/api/mbti/**", "/api/product/terms/*/pdf", "/api/product/join/*/terms/*/pdf", "/api/product/join/*/terms/*/pdf/page/*").permitAll()
